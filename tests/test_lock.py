...
async def test_lock_masks_stale_readback_until_second_update(hass: HomeAssistant) -> None:
    ...
    assert entity.is_locked is True  # still masked

    coordinator.data = {PPID: make_charger(remote_lock_off_mode=True)}
